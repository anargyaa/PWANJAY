...
<html>
    ...
    <body style="background:#E6CBA8;">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
                    <?php if(!empty($_SESSION['ADMIN'])){?>
                    <br/>
                    <span style="color:#fff";>Selamat Datang,di Sapunadin<?php echo $sesi['nama_pengguna'];?></span>
                    <a href="tambah.php" class="btn btn-info btn-md float-right" m><span class="fa fa-plus"></span> Tambah</a>
                    <br/><br/>
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="edit.php?id=<?php echo $isi['id_login'];?>" class="btn btn-info btn-md">
                            ...
                            <a href="logout.php" class="btn btn-danger btn-md float-left"><span class="fa fa-sign-out"></span> Logout</a>
                    <br/><br/>
                        </div>
                    </div>
                    <?php }else{?>
